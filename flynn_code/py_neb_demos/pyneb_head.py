...
V_func = utils.V_HO_LEPS#py_neb.NDInterpWithBoundary(uniq_coords,EE,boundaryHandler='exponential',minVal=0)
...
V_func_shift = utilities.shift_func(V_func,shift=-1.0*E_gs)

fig, ax = plt.subplots(1,1,figsize = (12, 10))
im = ax.contourf(grids[0],grids[1],EE,cmap='Spectral_r',extend='both',levels=MaxNLocator(nbins = 200).tick_values(-5,5))
ax.contour(grids[0],grids[1],EE,colors=['black'],levels=MaxNLocator(nbins = 20).tick_values(-5,5))      
...
RN = minima_coords[1]#(310,25) # NEB end point
